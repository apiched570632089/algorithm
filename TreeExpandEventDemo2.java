...
public class TreeExpandEventDemo2 extends JPanel {
  //  public  String s  =  new String("(2*(5-1))+(3*2)");
    public String s = JOptionPane.showInputDialog("เลือก");  
    DemoArea demoArea;
    JTextArea textArea;
 ...
 ///////////////////////////////////////////////////////////////////////////////
 /////////////////////////////////กราฟ/////////////////////////////////////////           
         char character = s.charAt(9);
            int S1= character;
            root = new DefaultMutableTreeNode(character);
            
            character = s.charAt(2);
            int S2= character;
            grandparent = new DefaultMutableTreeNode(character);
            root.add(grandparent);
            
            //
            character = s.charAt(1);
            parent = new DefaultMutableTreeNode(character);
           ...
           // parent.add(child);
            //
            character = s.charAt(5);
            parent = new DefaultMutableTreeNode(character);
            grandparent.add(parent);
            character = s.charAt(4);
            child = new DefaultMutableTreeNode(character);
            parent.add(child);
            character = s.charAt(6);
            child = new DefaultMutableTreeNode(character);
            parent.add(child);
             
            character = s.charAt(12);
            grandparent = new DefaultMutableTreeNode(character);
            root.add(grandparent);
            //
            character = s.charAt(11);
            parent = new DefaultMutableTreeNode(character);
            grandparent.add(parent);
